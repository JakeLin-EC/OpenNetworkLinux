...
#define PSU_SYSFS_PATH "/sys/devices/platform/ascvolt16_psu/"
#define FAN_BOARD_PATH "/sys/devices/platform/ascvolt16_fan/"
#define IDPROM_PATH    "/sys/devices/platform/ascvolt16_sys/eeprom"
