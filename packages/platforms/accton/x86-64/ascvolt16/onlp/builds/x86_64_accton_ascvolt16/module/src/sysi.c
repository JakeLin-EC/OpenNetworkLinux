...
#include "x86_64_accton_ascvolt16_int.h"
#include "x86_64_accton_ascvolt16_log.h"

#define NUM_OF_CPLD_VER 3

static char* cpld_ver_path[NUM_OF_CPLD_VER] = {
    "/sys/devices/platform/ascvolt16_sys/cpu_cpld_ver",  /* CPU  CPLD */
    "/sys/devices/platform/ascvolt16_sys/fpga_cpld_ver", /* FPGA CPLD */
    "/sys/devices/platform/ascvolt16_sys/main_cpld_ver", /* Main CPLD */
};

const char*
onlp_sysi_platform_get(void)
{
    return "x86-64-accton-ascvolt16-r0";
}
