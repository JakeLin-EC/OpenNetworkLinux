...
static char* ipmi_devfiles__[] = { /* must map with onlp_thermal_id */
    NULL,
    NULL,
    "/sys/devices/platform/ascvolt16_thermal/temp1_input",
    "/sys/devices/platform/ascvolt16_thermal/temp2_input",
    "/sys/devices/platform/ascvolt16_thermal/temp3_input",
    "/sys/devices/platform/ascvolt16_thermal/temp4_input",
    "/sys/devices/platform/ascvolt16_thermal/temp5_input",
    "/sys/devices/platform/ascvolt16_psu/psu1_temp1_input",
    "/sys/devices/platform/ascvolt16_psu/psu2_temp1_input",
};
...
#define ASCVOLT16_THERMAL_CAPS (ONLP_THERMAL_CAPS_GET_TEMPERATURE | \
			     ONLP_THERMAL_CAPS_GET_WARNING_THRESHOLD | \
			     ONLP_THERMAL_CAPS_GET_ERROR_THRESHOLD | \
			     ONLP_THERMAL_CAPS_GET_SHUTDOWN_THRESHOLD)

#define ASCVOLT16_PSU_CAPS (ONLP_THERMAL_CAPS_GET_TEMPERATURE | \
			     ONLP_THERMAL_CAPS_GET_ERROR_THRESHOLD)
...
static onlp_thermal_info_t linfo[] = {
    ...
    { { ONLP_THERMAL_ID_CREATE(THERMAL_CPU_CORE), "CPU Core", 0, {0} },
            ...
            ASCVOLT16_THERMAL_CAPS, 0, ONLP_THERMAL_THRESHOLD_INIT_DEFAULTS
        },
    ...
    { { ONLP_THERMAL_ID_CREATE(THERMAL_1_ON_PSU1), "PSU-1 Thermal Sensor 1", ONLP_PSU_ID_CREATE(PSU1_ID), {0} },
            ONLP_THERMAL_STATUS_PRESENT,
            ASCVOLT16_PSU_CAPS, 0, ONLP_THERMAL_THRESHOLD_INIT_DEFAULTS
        },
